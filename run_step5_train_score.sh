...
LOG_FILE="$LOG_DIR/step5_train_score_${TIMESTAMP}.log"
PID_FILE="$PID_DIR/step5_train_score.pid"
LOGGER_PID_FILE="$PID_DIR/step5_train_score_logger.pid"
CONTAINER_NAME="aistockcn-step5-train-score-${TIMESTAMP}"
...
echo "Step 5 train-and-score started"
