...
LOG_FILE="$LOG_DIR/step3_feature_engineering_${TIMESTAMP}.log"
PID_FILE="$PID_DIR/step3_feature_engineering.pid"
LOGGER_PID_FILE="$PID_DIR/step3_feature_engineering_logger.pid"
CONTAINER_NAME="aistockcn-step3-feature-engineering-${TIMESTAMP}"
...
echo "Step 3 feature engineering started"
