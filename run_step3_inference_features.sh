...
LOG_FILE="$LOG_DIR/step3_inference_features_${TIMESTAMP}.log"
PID_FILE="$PID_DIR/step3_inference_features.pid"
LOGGER_PID_FILE="$PID_DIR/step3_inference_features_logger.pid"
CONTAINER_NAME="aistockcn-step3-inference-features-${TIMESTAMP}"
...
echo "Step 3 inference features started"
