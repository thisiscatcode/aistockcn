...
LOG_FILE="$LOG_DIR/step6_backtest_${TIMESTAMP}.log"
PID_FILE="$PID_DIR/step6_backtest.pid"
LOGGER_PID_FILE="$PID_DIR/step6_backtest_logger.pid"
CONTAINER_NAME="aistockcn-step6-backtest-${TIMESTAMP}"
